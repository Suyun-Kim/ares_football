  ...
  <div>
    ...
    <section style="overflow: hidden;">
      <div class="wrap">
        ...
        <div class="tt">참석 목록</div>

        <div id='test-table' style="overflow: auto;">
          <table class="team_r">
            <tr><th style="width:100%;">참석( {{ game_vote_cnt.vate_cnt }} 명 )</th></tr>
            <tr v-for="game_vote in game_vote_list">
              <td style="width:100%;" v-if="game_vote.vate === '참석'">{{ game_vote.member_id }}</td>
            </tr>
          </table>
        </div>
